export const base_url = "https://api.themoviedb.org/3/" // help: https://developer.themoviedb.org/reference/ 
const urlGenres = `${base_url}genre/` /*${type}/list?api_key=${import.meta.env.VITE_API_KEY}*/

const getTmdbMetadata = function () {
    // fetch tmdb-metadata
    const metadata = { apiKey: import.meta.env.VITE_TMDB_API_KEY, error: null }
    console.log('getTmdbMetadata metadata', metadata);
    return metadata
}
